...
enum opt_code
{
  ...
  OPT_Wnonportable_cfstrings = 309,          /* -Wnonportable-cfstrings */
  /* OPT_Wnormalized = 310, */               /* -Wnormalized */
  OPT_Wnormalized_ = 311,                    /* -Wnormalized= */
  OPT_Wnull = 312,                           /* -Wnull */
  OPT_Wodr = 313,                            /* -Wodr */
  OPT_Wold_style_cast = 314,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 315,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 316,           /* -Wold-style-definition */
  OPT_Wopenmp_simd = 317,                    /* -Wopenmp-simd */
  OPT_Wout_of_date = 318,                    /* -Wout-of-date */
  OPT_Wover_ann = 319,                       /* -Wover-ann */
  OPT_Woverflow = 320,                       /* -Woverflow */
  OPT_Woverlength_strings = 321,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 322,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 323,                  /* -Woverride-init */
  OPT_Wp_ = 324,                             /* -Wp, */
  OPT_Wpacked = 325,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 326,         /* -Wpacked-bitfield-compat */
  OPT_Wpadded = 327,                         /* -Wpadded */
  OPT_Wparam_assign = 328,                   /* -Wparam-assign */
  OPT_Wparentheses = 329,                    /* -Wparentheses */
  OPT_Wpedantic = 330,                       /* -Wpedantic */
  OPT_Wpkg_default_method = 331,             /* -Wpkg-default-method */
  OPT_Wpmf_conversions = 332,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 333,                  /* -Wpointer-arith */
  OPT_Wpointer_sign = 334,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 335,            /* -Wpointer-to-int-cast */
  OPT_Wpragmas = 336,                        /* -Wpragmas */
  OPT_Wproperty_assign_default = 337,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 338,                       /* -Wprotocol */
  OPT_Wpsabi = 339,                          /* -Wpsabi */
  OPT_Wraw = 340,                            /* -Wraw */
  OPT_Wreal_q_constant = 341,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 342,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 343,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 344,                /* -Wredundant-decls */
  OPT_Wredundant_modifiers = 345,            /* -Wredundant-modifiers */
  OPT_Wreorder = 346,                        /* -Wreorder */
  OPT_Wreturn_local_addr = 347,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 348,                    /* -Wreturn-type */
  OPT_Wselector = 349,                       /* -Wselector */
  OPT_Wsequence_point = 350,                 /* -Wsequence-point */
  OPT_Wserial = 351,                         /* -Wserial */
  OPT_Wshadow = 352,                         /* -Wshadow */
  OPT_Wshadow_ivar = 353,                    /* -Wshadow-ivar */
  OPT_Wshift_count_negative = 354,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 355,           /* -Wshift-count-overflow */
  OPT_Wsign_compare = 356,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 357,                /* -Wsign-conversion */
  OPT_Wsign_promo = 358,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 359,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 360,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_pointer_memaccess = 361,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspecial_param_hiding = 362,           /* -Wspecial-param-hiding */
  OPT_Wstack_protector = 363,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 364,                   /* -Wstack-usage= */
  OPT_Wstatic_access = 365,                  /* -Wstatic-access */
  OPT_Wstatic_receiver = 366,                /* -Wstatic-receiver */
  ...
  OPT_Wsuggest_attribute_const = 374,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 375,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_noreturn = 376,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 377,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 378,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 379,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 380,               /* -Wsuggest-override */
  OPT_Wsuppress = 381,                       /* -Wsuppress */
  ...
  OPT_Wsync_nand = 387,                      /* -Wsync-nand */
  OPT_Wsynth = 388,                          /* -Wsynth */
  OPT_Wsynthetic_access = 389,               /* -Wsynthetic-access */
  OPT_Wsystem_headers = 390,                 /* -Wsystem-headers */
  OPT_Wtabs = 391,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 392,                /* -Wtarget-lifetime */
  OPT_Wtasks = 393,                          /* -Wtasks */
  OPT_Wtraditional = 394,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 395,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 396,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 397,                      /* -Wtrigraphs */
  OPT_Wtype_hiding = 398,                    /* -Wtype-hiding */
  OPT_Wtype_limits = 399,                    /* -Wtype-limits */
  OPT_Wuncheck = 400,                        /* -Wuncheck */
  OPT_Wundeclared_selector = 401,            /* -Wundeclared-selector */
  OPT_Wundef = 402,                          /* -Wundef */
  OPT_Wunderflow = 403,                      /* -Wunderflow */
  OPT_Wuninitialized = 404,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 405,                /* -Wunknown-pragmas */
  OPT_Wunnecessary_else = 406,               /* -Wunnecessary-else */
  OPT_Wunqualified_field = 407,              /* -Wunqualified-field */
  /* OPT_Wunreachable_code = 408, */         /* -Wunreachable-code */
  OPT_Wunsafe_loop_optimizations = 409,      /* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 410,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 411,                         /* -Wunused */
  OPT_Wunused_argument = 412,                /* -Wunused-argument */
  ...
  OPT_Wunused_import = 417,                  /* -Wunused-import */
  OPT_Wunused_label = 418,                   /* -Wunused-label */
  OPT_Wunused_local = 419,                   /* -Wunused-local */
  ...
  OPT_Wunused_private = 423,                 /* -Wunused-private */
  OPT_Wunused_result = 424,                  /* -Wunused-result */
  OPT_Wunused_thrown = 425,                  /* -Wunused-thrown */
  OPT_Wunused_value = 426,                   /* -Wunused-value */
  OPT_Wunused_variable = 427,                /* -Wunused-variable */
  OPT_Wuse_without_only = 428,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 429,                   /* -Wuseless-cast */
  OPT_Wuseless_type_check = 430,             /* -Wuseless-type-check */
  OPT_Wvarargs = 431,                        /* -Wvarargs */
  OPT_Wvarargs_cast = 432,                   /* -Wvarargs-cast */
  OPT_Wvariadic_macros = 433,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 434,   /* -Wvector-operation-performance */
  OPT_Wvirtual_move_assign = 435,            /* -Wvirtual-move-assign */
  OPT_Wvla = 436,                            /* -Wvla */
  OPT_Wvolatile_register_var = 437,          /* -Wvolatile-register-var */
  OPT_Wwarning_token = 438,                  /* -Wwarning-token */
  OPT_Wwrite_strings = 439,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 440,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzerotrip = 441,                       /* -Wzerotrip */
  OPT_X = 442,                               /* -X */
  OPT_Xassembler = 443,                      /* -Xassembler */
  OPT_Xlinker = 444,                         /* -Xlinker */
  OPT_Xpreprocessor = 445,                   /* -Xpreprocessor */
  OPT_Z = 446,                               /* -Z */
  OPT_Zall_load = 447,                       /* -Zall_load */
  OPT_Zallowable_client = 448,               /* -Zallowable_client */
  OPT_Zarch_errors_fatal = 449,              /* -Zarch_errors_fatal */
  OPT_Zbind_at_load = 450,                   /* -Zbind_at_load */
  OPT_Zbundle = 451,                         /* -Zbundle */
  OPT_Zbundle_loader = 452,                  /* -Zbundle_loader */
  OPT_Zdead_strip = 453,                     /* -Zdead_strip */
  OPT_Zdylib_file = 454,                     /* -Zdylib_file */
  OPT_Zdynamic = 455,                        /* -Zdynamic */
  OPT_Zdynamiclib = 456,                     /* -Zdynamiclib */
  OPT_Zexported_symbols_list = 457,          /* -Zexported_symbols_list */
  OPT_Zflat_namespace = 458,                 /* -Zflat_namespace */
  OPT_Zfn_seg_addr_table_filename = 459,     /* -Zfn_seg_addr_table_filename */
  OPT_Zforce_cpusubtype_ALL = 460,           /* -Zforce_cpusubtype_ALL */
  OPT_Zforce_flat_namespace = 461,           /* -Zforce_flat_namespace */
  OPT_Zimage_base = 462,                     /* -Zimage_base */
  OPT_Zinit = 463,                           /* -Zinit */
  OPT_Zinstall_name = 464,                   /* -Zinstall_name */
  OPT_Zmulti_module = 465,                   /* -Zmulti_module */
  OPT_Zmultiply_defined = 466,               /* -Zmultiply_defined */
  OPT_Zmultiplydefinedunused = 467,          /* -Zmultiplydefinedunused */
  OPT_Zno_dead_strip_inits_and_terms = 468,  /* -Zno_dead_strip_inits_and_terms */
  OPT_Zseg_addr_table = 469,                 /* -Zseg_addr_table */
  OPT_Zsegaddr = 470,                        /* -Zsegaddr */
  OPT_Zsegs_read_only_addr = 471,            /* -Zsegs_read_only_addr */
  OPT_Zsegs_read_write_addr = 472,           /* -Zsegs_read_write_addr */
  OPT_Zsingle_module = 473,                  /* -Zsingle_module */
  OPT_Zumbrella = 474,                       /* -Zumbrella */
  OPT_Zunexported_symbols_list = 475,        /* -Zunexported_symbols_list */
  OPT_Zweak_reference_mismatches = 476,      /* -Zweak_reference_mismatches */
  /* OPT_all_load = 477, */                  /* -all_load */
  /* OPT_allowable_client = 478, */          /* -allowable_client */
  OPT_ansi = 479,                            /* -ansi */
  OPT_arch = 480,                            /* -arch */
  /* OPT_arch_errors_fatal = 481, */         /* -arch_errors_fatal */
  OPT_aux_info = 482,                        /* -aux-info */
  /* OPT_aux_info_ = 483, */                 /* -aux-info= */
  OPT_auxbase = 484,                         /* -auxbase */
  OPT_auxbase_strip = 485,                   /* -auxbase-strip */
  /* OPT_bind_at_load = 486, */              /* -bind_at_load */
  /* OPT_bootclasspath = 487, */             /* -bootclasspath */
  /* OPT_bundle = 488, */                    /* -bundle */
  /* OPT_bundle_loader = 489, */             /* -bundle_loader */
  OPT_c = 490,                               /* -c */
  /* OPT_classpath = 491, */                 /* -classpath */
  OPT_client_name = 492,                     /* -client_name */
  OPT_compatibility_version = 493,           /* -compatibility_version */
  OPT_coverage = 494,                        /* -coverage */
  OPT_cpp = 495,                             /* -cpp */
  OPT_cpp_ = 496,                            /* -cpp= */
  OPT_current_version = 497,                 /* -current_version */
  OPT_d = 498,                               /* -d */
  /* OPT_dead_strip = 499, */                /* -dead_strip */
  /* OPT_dependency_file = 500, */           /* -dependency-file */
  OPT_dumpbase = 501,                        /* -dumpbase */
  OPT_dumpdir = 502,                         /* -dumpdir */
  OPT_dumpmachine = 503,                     /* -dumpmachine */
  OPT_dumpspecs = 504,                       /* -dumpspecs */
  OPT_dumpversion = 505,                     /* -dumpversion */
  /* OPT_dylib_file = 506, */                /* -dylib_file */
  OPT_dylinker = 507,                        /* -dylinker */
  OPT_dylinker_install_name = 508,           /* -dylinker_install_name */
  /* OPT_dynamic = 509, */                   /* -dynamic */
  /* OPT_dynamiclib = 510, */                /* -dynamiclib */
  OPT_e = 511,                               /* -e */
  /* OPT_encoding = 512, */                  /* -encoding */
  OPT_export_dynamic = 513,                  /* -export-dynamic */
  /* OPT_exported_symbols_list = 514, */     /* -exported_symbols_list */
  OPT_extdirs = 515,                         /* -extdirs */
  /* OPT_fCLASSPATH_ = 516, */               /* -fCLASSPATH= */
  OPT_fPIC = 517,                            /* -fPIC */
  OPT_fPIE = 518,                            /* -fPIE */
  OPT_fRTS_ = 519,                           /* -fRTS= */
  ...
  OPT_fall_intrinsics = 535,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 536, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 537,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 538,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 539, */   /* -falt-external-templates */
  OPT_fapple_kext = 540,                     /* -fapple-kext */
  /* OPT_fargument_alias = 541, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 542, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 543, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 544, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 545,            /* -fasan-shadow-offset= */
  OPT_fasm = 546,                            /* -fasm */
  OPT_fassert = 547,                         /* -fassert */
  OPT_fassociative_math = 548,               /* -fassociative-math */
  OPT_fassume_compiled = 549,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 550,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 551,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 552,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 553,                   /* -fauto-profile */
  OPT_fauto_profile_ = 554,                  /* -fauto-profile= */
  OPT_fautomatic = 555,                      /* -fautomatic */
  OPT_faux_classpath = 556,                  /* -faux-classpath */
  OPT_fbackslash = 557,                      /* -fbackslash */
  OPT_fbacktrace = 558,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 559,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 560,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 561,              /* -fbootstrap-classes */
  OPT_fbounds_check = 562,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 563,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 564,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 565,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 566,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 567,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 568,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 569,                        /* -fbuiltin */
  OPT_fbuiltin_ = 570,                       /* -fbuiltin- */
  OPT_fcall_saved_ = 571,                    /* -fcall-saved- */
  OPT_fcall_used_ = 572,                     /* -fcall-used- */
  OPT_fcaller_saves = 573,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 574,       /* -fcanonical-system-headers */
  OPT_fcheck_array_temporaries = 575,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 576,                /* -fcheck-data-deps */
  OPT_fcheck_new = 577,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 578,           /* -fcheck-pointer-bounds */
  OPT_fcheck_references = 579,               /* -fcheck-references */
  OPT_fcheck_ = 580,                         /* -fcheck= */
  ...
  OPT_fchkp_instrument_calls = 585,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 586,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 587,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 588, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 589,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 590,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 591,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 592, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 593,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 594,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 595,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 596,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 597,/* -fchkp-zero-input-bounds-for-main */
  OPT_fcilkplus = 598,                       /* -fcilkplus */
  OPT_fclasspath_ = 599,                     /* -fclasspath= */
  OPT_fcoarray_ = 600,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 601,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 602,                         /* -fcommon */
  OPT_fcompare_debug = 603,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 604,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 605,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 606,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 607,              /* -fcompile-resource= */
  OPT_fcond_mismatch = 608,                  /* -fcond-mismatch */
  OPT_fconserve_space = 609,                 /* -fconserve-space */
  OPT_fconserve_stack = 610,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 611,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 612,               /* -fconstexpr-depth= */
  OPT_fconvert_ = 613,                       /* -fconvert= */
  OPT_fcprop_registers = 614,                /* -fcprop-registers */
  OPT_fcray_pointer = 615,                   /* -fcray-pointer */
  OPT_fcrossjumping = 616,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 617,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 618, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 619,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 620,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 621,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 622,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 623,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 624,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 625,                       /* -fdbg-cnt= */
  OPT_fdce = 626,                            /* -fdce */
  OPT_fdebug_cpp = 627,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 628,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 629,            /* -fdebug-types-section */
  OPT_fdeclone_ctor_dtor = 630,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 631,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 632,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 633, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 634,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 635,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 636,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 637,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 638,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 639,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 640,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 641,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 642,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 643, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 644,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_show_caret = 645,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 646,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 647,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 648,                /* -fdirectives-only */
  OPT_fdisable_ = 649,                       /* -fdisable- */
  OPT_fdisable_assertions = 650,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 651,            /* -fdisable-assertions= */
  OPT_fdollar_ok = 652,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 653,         /* -fdollars-in-identifiers */
  OPT_fdse = 654,                            /* -fdse */
  OPT_fdump_ = 655,                          /* -fdump- */
  OPT_fdump_ada_spec = 656,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 657,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 658, */                /* -fdump-core */
  OPT_fdump_final_insns = 659,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 660,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 661,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 662,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 663,                  /* -fdump-go-spec= */
  OPT_fdump_noaddr = 664,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 665, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 666,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 667,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 668,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 669,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 670,                 /* -fearly-inlining */
  OPT_felide_constructors = 671,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 672,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 673, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 674,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 675,        /* -femit-class-debug-always */
  OPT_femit_class_file = 676,                /* -femit-class-file */
  OPT_femit_class_files = 677,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 678,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 679,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 680,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 681,                        /* -fenable- */
  OPT_fenable_assertions = 682,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 683,             /* -fenable-assertions= */
  OPT_fencoding_ = 684,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 685,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 686, */           /* -fenum-int-equiv */
  OPT_fexceptions = 687,                     /* -fexceptions */
  OPT_fexcess_precision_ = 688,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 689,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 690,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 691,           /* -fext-numeric-literals */
  OPT_fextdirs_ = 692,                       /* -fextdirs= */
  OPT_fextended_identifiers = 693,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 694,                /* -fextern-tls-init */
  OPT_fexternal_blas = 695,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 696, */       /* -fexternal-templates */
  OPT_ff2c = 697,                            /* -ff2c */
  OPT_ffast_math = 698,                      /* -ffast-math */
  OPT_ffat_lto_objects = 699,                /* -ffat-lto-objects */
  OPT_ffilelist_file = 700,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 701,               /* -ffinite-math-only */
  OPT_ffixed_ = 702,                         /* -ffixed- */
  OPT_ffixed_form = 703,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 704,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 705,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 706,                    /* -ffloat-store */
  OPT_ffor_scope = 707,                      /* -ffor-scope */
  /* OPT_fforce_addr = 708, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 709,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 710,              /* -fforward-propagate */
  OPT_ffp_contract_ = 711,                   /* -ffp-contract= */
  OPT_ffpe_summary_ = 712,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 713,                      /* -ffpe-trap= */
  OPT_ffree_form = 714,                      /* -ffree-form */
  OPT_ffree_line_length_ = 715,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 716,          /* -ffree-line-length-none */
  OPT_ffreestanding = 717,                   /* -ffreestanding */
  OPT_ffriend_injection = 718,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 719,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 720,                   /* -ffunction-cse */
  OPT_ffunction_sections = 721,              /* -ffunction-sections */
  OPT_fgcse = 722,                           /* -fgcse */
  OPT_fgcse_after_reload = 723,              /* -fgcse-after-reload */
  OPT_fgcse_las = 724,                       /* -fgcse-las */
  OPT_fgcse_lm = 725,                        /* -fgcse-lm */
  OPT_fgcse_sm = 726,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 727,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 728,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 729,                         /* -fgnu-tm */
  OPT_fgnu_unique = 730,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 731,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 732,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 733,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 734,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 735,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 736,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 737,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 738,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 739,                       /* -fgraphite */
  OPT_fgraphite_identity = 740,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 741,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 742, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 743, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 744,           /* -fhash-synchronization */
  /* OPT_fhelp = 745, */                     /* -fhelp */
  /* OPT_fhelp_ = 746, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 747,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 748, */                /* -fhonor-std */
  OPT_fhosted = 749,                         /* -fhosted */
  /* OPT_fhuge_objects = 750, */             /* -fhuge-objects */
  OPT_fident = 751,                          /* -fident */
  OPT_fif_conversion = 752,                  /* -fif-conversion */
  OPT_fif_conversion2 = 753,                 /* -fif-conversion2 */
  OPT_filelist = 754,                        /* -filelist */
  OPT_fimplement_inlines = 755,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 756,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 757,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 758,             /* -fimplicit-templates */
  OPT_findirect_classes = 759,               /* -findirect-classes */
  OPT_findirect_dispatch = 760,              /* -findirect-dispatch */
  OPT_findirect_inlining = 761,              /* -findirect-inlining */
  OPT_findirect_virtual_calls = 762,         /* -findirect-virtual-calls */
  OPT_finhibit_size_directive = 763,         /* -finhibit-size-directive */
  OPT_finit_character_ = 764,                /* -finit-character= */
  OPT_finit_integer_ = 765,                  /* -finit-integer= */
  OPT_finit_local_zero = 766,                /* -finit-local-zero */
  OPT_finit_logical_ = 767,                  /* -finit-logical= */
  OPT_finit_real_ = 768,                     /* -finit-real= */
  OPT_finline = 769,                         /* -finline */
  OPT_finline_atomics = 770,                 /* -finline-atomics */
  OPT_finline_functions = 771,               /* -finline-functions */
  OPT_finline_functions_called_once = 772,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 773, */            /* -finline-limit- */
  OPT_finline_limit_ = 774,                  /* -finline-limit= */
  OPT_finline_small_functions = 775,         /* -finline-small-functions */
  OPT_finput_charset_ = 776,                 /* -finput-charset= */
  OPT_finstrument_functions = 777,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 778,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 779,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 780,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 781,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 782,        /* -fintrinsic-modules-path= */
  OPT_fipa_cp = 783,                         /* -fipa-cp */
  OPT_fipa_cp_alignment = 784,               /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 785,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 786,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 787,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 788,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 789, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 790,                    /* -fipa-profile */
  OPT_fipa_pta = 791,                        /* -fipa-pta */
  OPT_fipa_pure_const = 792,                 /* -fipa-pure-const */
  OPT_fipa_ra = 793,                         /* -fipa-ra */
  OPT_fipa_reference = 794,                  /* -fipa-reference */
  OPT_fipa_sra = 795,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 796, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 797,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 798,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 799,              /* -fira-loop-pressure */
  OPT_fira_region_ = 800,                    /* -fira-region= */
  OPT_fira_share_save_slots = 801,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 802,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 803,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 804,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 805,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 806,               /* -fivar-visibility= */
  OPT_fivopts = 807,                         /* -fivopts */
  OPT_fjni = 808,                            /* -fjni */
  OPT_fjump_tables = 809,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 810,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 811,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 812,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 813, */                /* -flabels-ok */
  /* OPT_flat_namespace = 814, */            /* -flat_namespace */
  OPT_flax_vector_conversions = 815,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 816,             /* -fleading-underscore */
  OPT_flifetime_dse = 817,                   /* -flifetime-dse */
  OPT_flive_range_shrinkage = 818,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 819,                    /* -flocal-ivars */
  OPT_floop_block = 820,                     /* -floop-block */
  /* OPT_floop_flatten = 821, */             /* -floop-flatten */
  OPT_floop_interchange = 822,               /* -floop-interchange */
  OPT_floop_nest_optimize = 823,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 824, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 825,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 826,                /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 827,            /* -floop-unroll-and-jam */
  OPT_flra_remat = 828,                      /* -flra-remat */
  OPT_flto = 829,                            /* -flto */
  OPT_flto_compression_level_ = 830,         /* -flto-compression-level= */
  OPT_flto_odr_type_merging = 831,           /* -flto-odr-type-merging */
  OPT_flto_partition_ = 832,                 /* -flto-partition= */
  OPT_flto_report = 833,                     /* -flto-report */
  OPT_flto_report_wpa = 834,                 /* -flto-report-wpa */
  OPT_flto_ = 835,                           /* -flto= */
  OPT_fltrans = 836,                         /* -fltrans */
  OPT_fltrans_output_list_ = 837,            /* -fltrans-output-list= */
  OPT_fmain_ = 838,                          /* -fmain= */
  OPT_fmath_errno = 839,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 840,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 841,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 842,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 843,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 844,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 845,                     /* -fmem-report */
  OPT_fmem_report_wpa = 846,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 847,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 848,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 849,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 850,                /* -fmessage-length= */
  OPT_fmodule_private = 851,                 /* -fmodule-private */
  OPT_fmodulo_sched = 852,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 853,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 854,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 855,                  /* -fms-extensions */
  /* OPT_fmudflap = 856, */                  /* -fmudflap */
  /* OPT_fmudflapir = 857, */                /* -fmudflapir */
  /* OPT_fmudflapth = 858, */                /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 859, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 860, */                  /* -fnew-abi */
  OPT_fnext_runtime = 861,                   /* -fnext-runtime */
  OPT_fnil_receivers = 862,                  /* -fnil-receivers */
  /* OPT_fno_vect_cost_model = 863, */       /* -fno-vect-cost-model */
  OPT_fnon_call_exceptions = 864,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 865,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 866, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 867,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 868,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 869,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 870,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 871,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 872,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 873,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 874,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 875,                 /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 876,                   /* -foffload-abi= */
  OPT_foffload_ = 877,                       /* -foffload= */
  OPT_fomit_frame_pointer = 878,             /* -fomit-frame-pointer */
  OPT_fopenacc = 879,                        /* -fopenacc */
  OPT_fopenmp = 880,                         /* -fopenmp */
  OPT_fopenmp_simd = 881,                    /* -fopenmp-simd */
  OPT_foperator_names = 882,                 /* -foperator-names */
  OPT_fopt_info = 883,                       /* -fopt-info */
  OPT_fopt_info_ = 884,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 885, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 886,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 887,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 888,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 889, */           /* -foptional-diags */
  /* OPT_force_cpusubtype_ALL = 890, */      /* -force_cpusubtype_ALL */
  /* OPT_force_flat_namespace = 891, */      /* -force_flat_namespace */
  OPT_foutput_class_dir_ = 892,              /* -foutput-class-dir= */
  OPT_fpack_derived = 893,                   /* -fpack-derived */
  OPT_fpack_struct = 894,                    /* -fpack-struct */
  OPT_fpack_struct_ = 895,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 896,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 897,              /* -fpcc-struct-return */
  OPT_fpch_deps = 898,                       /* -fpch-deps */
  OPT_fpch_preprocess = 899,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 900,                     /* -fpeel-loops */
  OPT_fpeephole = 901,                       /* -fpeephole */
  OPT_fpeephole2 = 902,                      /* -fpeephole2 */
  OPT_fpermissive = 903,                     /* -fpermissive */
  OPT_fpic = 904,                            /* -fpic */
  OPT_fpie = 905,                            /* -fpie */
  OPT_fplan9_extensions = 906,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 907,                    /* -fplugin-arg- */
  OPT_fplugin_ = 908,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 909,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 910,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 911,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 912,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 913,                   /* -fpreprocessed */
  OPT_fpretty_templates = 914,               /* -fpretty-templates */
  OPT_fprofile = 915,                        /* -fprofile */
  OPT_fprofile_arcs = 916,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 917,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 918,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 919,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 920,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 921,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 922,                 /* -fprofile-report */
  OPT_fprofile_use = 923,                    /* -fprofile-use */
  OPT_fprofile_use_ = 924,                   /* -fprofile-use= */
  OPT_fprofile_values = 925,                 /* -fprofile-values */
  OPT_fprotect_parens = 926,                 /* -fprotect-parens */
  OPT_framework = 927,                       /* -framework */
  OPT_frandom_seed = 928,                    /* -frandom-seed */
  OPT_frandom_seed_ = 929,                   /* -frandom-seed= */
  OPT_frange_check = 930,                    /* -frange-check */
  OPT_freal_4_real_10 = 931,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 932,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 933,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 934,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 935,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 936,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 937,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 938,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 939,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 940,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 941,                /* -frecord-marker=8 */
  OPT_frecursive = 942,                      /* -frecursive */
  OPT_freduced_reflection = 943,             /* -freduced-reflection */
  OPT_free = 944,                            /* -free */
  OPT_freg_struct_return = 945,              /* -freg-struct-return */
  /* OPT_fregmove = 946, */                  /* -fregmove */
  OPT_frename_registers = 947,               /* -frename-registers */
  OPT_freorder_blocks = 948,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 949,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 950,              /* -freorder-functions */
  OPT_frepack_arrays = 951,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 952,           /* -freplace-objc-classes */
  OPT_frepo = 953,                           /* -frepo */
  OPT_freport_bug = 954,                     /* -freport-bug */
  OPT_frequire_return_statement = 955,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 956,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 957, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 958,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 959,                    /* -fresolution= */
  OPT_frounding_math = 960,                  /* -frounding-math */
  OPT_frtti = 961,                           /* -frtti */
  OPT_fsanitize_recover = 962,               /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 963,              /* -fsanitize-recover= */
  OPT_fsanitize_undefined_trap_on_error = 964,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 965,                      /* -fsanitize= */
  OPT_fsaw_java_file = 966,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 967,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 968,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 969,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 970,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 971,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 972,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 973,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 974,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 975,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 976,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 977,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 978,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 979,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 980,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 981,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 982,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 983,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 984, */        /* -fsched2-use-traces */
  OPT_fschedule_fusion = 985,                /* -fschedule-fusion */
  OPT_fschedule_insns = 986,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 987,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 988,              /* -fsecond-underscore */
  OPT_fsection_anchors = 989,                /* -fsection-anchors */
  /* OPT_fsee = 990, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 991,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 992,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 993, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 994,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 995,          /* -fselective-scheduling2 */
  OPT_fsemantic_interposition = 996,         /* -fsemantic-interposition */
  OPT_fshort_double = 997,                   /* -fshort-double */
  OPT_fshort_enums = 998,                    /* -fshort-enums */
  OPT_fshort_wchar = 999,                    /* -fshort-wchar */
  OPT_fshow_column = 1000,                   /* -fshow-column */
  OPT_fshrink_wrap = 1001,                   /* -fshrink-wrap */
  OPT_fsign_zero = 1002,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1003,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1004,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1005,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1006,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1007,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1008,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1009,            /* -fsized-deallocation */
  OPT_fsource_filename_ = 1010,              /* -fsource-filename= */
  OPT_fsource_ = 1011,                       /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 1012,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 1013,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1014,              /* -fsplit-wide-types */
  /* OPT_fsquangle = 1015, */                /* -fsquangle */
  OPT_fssa_phiopt = 1016,                    /* -fssa-phiopt */
  OPT_fstack_arrays = 1017,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1018, */             /* -fstack-check */
  OPT_fstack_check_ = 1019,                  /* -fstack-check= */
  OPT_fstack_limit = 1020,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1021,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1022,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1023,               /* -fstack-protector */
  OPT_fstack_protector_all = 1024,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1025,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1026,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1027,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1028,                   /* -fstack-usage */
  OPT_fstats = 1029,                         /* -fstats */
  OPT_fstdarg_opt = 1030,                    /* -fstdarg-opt */
  OPT_fstore_check = 1031,                   /* -fstore-check */
  /* OPT_fstrength_reduce = 1032, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1033,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1034,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1035,               /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 1036, */        /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1037,     /* -fstrict-volatile-bitfields */
  OPT_fsync_libcalls = 1038,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1039,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1040,                      /* -ftabstop= */
  /* OPT_ftarget_help = 1041, */             /* -ftarget-help */
  OPT_ftarget_ = 1042,                       /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 1043,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1044, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1045,               /* -ftemplate-depth= */
  OPT_fterminated_vtables = 1046,            /* -fterminated-vtables */
  OPT_ftest_coverage = 1047,                 /* -ftest-coverage */
  /* OPT_fthis_is_variable = 1048, */        /* -fthis-is-variable */
  OPT_fthread_jumps = 1049,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1050,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1051,                   /* -ftime-report */
  OPT_ftls_model_ = 1052,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1053,              /* -ftoplevel-reorder */
  OPT_ftracer = 1054,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1055,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1056,        /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 1057,                 /* -ftrapping-math */
  OPT_ftrapv = 1058,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1059,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1060,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1061,                      /* -ftree-ccp */
  OPT_ftree_ch = 1062,                       /* -ftree-ch */
  OPT_ftree_coalesce_inlined_vars = 1063,    /* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1064,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1065,                /* -ftree-copy-prop */
  OPT_ftree_copyrename = 1066,               /* -ftree-copyrename */
  OPT_ftree_cselim = 1067,                   /* -ftree-cselim */
  OPT_ftree_dce = 1068,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1069,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1070,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1071,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1072,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1073, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1074,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1075,          /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 1076,   /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1077,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1078,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1079, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1080,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1081,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1082,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1083,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1084,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1085,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1086,                      /* -ftree-pre */
  OPT_ftree_pta = 1087,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1088,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1089, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1090,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1091,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1092,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1093,                     /* -ftree-slsr */
  OPT_ftree_sra = 1094,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1095, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1096, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1097,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1098,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1099,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1100, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1101,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1102, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1103,                      /* -ftree-vrp */
  OPT_funderscoring = 1104,                  /* -funderscoring */
  OPT_funit_at_a_time = 1105,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1106,              /* -funroll-all-loops */
  OPT_funroll_loops = 1107,                  /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 1108,     /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1109,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1110,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1111,                 /* -funsigned-char */
  OPT_funswitch_loops = 1112,                /* -funswitch-loops */
  OPT_funwind_tables = 1113,                 /* -funwind-tables */
  OPT_fuse_atomic_builtins = 1114,           /* -fuse-atomic-builtins */
  ...
  OPT_gfull = 1159,                          /* -gfull */
  OPT_ggdb = 1160,                           /* -ggdb */
  OPT_ggnu_pubnames = 1161,                  /* -ggnu-pubnames */
  OPT_gnat = 1162,                           /* -gnat */
  OPT_gnatO = 1163,                          /* -gnatO */
  OPT_gno_pubnames = 1164,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1165,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1166,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1167,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1168,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1169,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1170,                   /* -gsplit-dwarf */
  OPT_gstabs = 1171,                         /* -gstabs */
  OPT_gstabs_ = 1172,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1173,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1174,                        /* -gtoggle */
  OPT_gused = 1175,                          /* -gused */
  OPT_gvms = 1176,                           /* -gvms */
  ...
  OPT_gz_ = 1180,                            /* -gz= */
  OPT_h = 1181,                              /* -h */
  OPT_headerpad_max_install_names = 1182,    /* -headerpad_max_install_names */
  OPT_idirafter = 1183,                      /* -idirafter */
  OPT_iframework = 1184,                     /* -iframework */
  OPT_imacros = 1185,                        /* -imacros */
  /* OPT_image_base = 1186, */               /* -image_base */
  OPT_imultiarch = 1187,                     /* -imultiarch */
  OPT_imultilib = 1188,                      /* -imultilib */
  OPT_include = 1189,                        /* -include */
  /* OPT_init = 1190, */                     /* -init */
  /* OPT_install_name = 1191, */             /* -install_name */
  OPT_iplugindir_ = 1192,                    /* -iplugindir= */
  OPT_iprefix = 1193,                        /* -iprefix */
  OPT_iquote = 1194,                         /* -iquote */
  OPT_isysroot = 1195,                       /* -isysroot */
  OPT_isystem = 1196,                        /* -isystem */
  OPT_iwithprefix = 1197,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1198,              /* -iwithprefixbefore */
  OPT_k8 = 1199,                             /* -k8 */
  OPT_keep_private_externs = 1200,           /* -keep_private_externs */
  OPT_l = 1201,                              /* -l */
  OPT_lang_asm = 1202,                       /* -lang-asm */
  OPT_m128bit_long_double = 1203,            /* -m128bit-long-double */
  OPT_m16 = 1204,                            /* -m16 */
  OPT_m32 = 1205,                            /* -m32 */
  OPT_m3dnow = 1206,                         /* -m3dnow */
  OPT_m3dnowa = 1207,                        /* -m3dnowa */
  OPT_m64 = 1208,                            /* -m64 */
  OPT_m80387 = 1209,                         /* -m80387 */
  OPT_m8bit_idiv = 1210,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1211,             /* -m96bit-long-double */
  OPT_mabi_ = 1212,                          /* -mabi= */
  OPT_mabm = 1213,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1214,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1215,                 /* -maddress-mode= */
  OPT_madx = 1216,                           /* -madx */
  OPT_maes = 1217,                           /* -maes */
  OPT_malign_data_ = 1218,                   /* -malign-data= */
  OPT_malign_double = 1219,                  /* -malign-double */
  OPT_malign_functions_ = 1220,              /* -malign-functions= */
  OPT_malign_jumps_ = 1221,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1222,                  /* -malign-loops= */
  OPT_malign_stringops = 1223,               /* -malign-stringops */
  OPT_march_ = 1224,                         /* -march= */
  OPT_masm_ = 1225,                          /* -masm= */
  OPT_matt_stubs = 1226,                     /* -matt-stubs */
  OPT_mavx = 1227,                           /* -mavx */
  OPT_mavx2 = 1228,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1229,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1230,  /* -mavx256-split-unaligned-store */
  OPT_mavx512bw = 1231,                      /* -mavx512bw */
  OPT_mavx512cd = 1232,                      /* -mavx512cd */
  OPT_mavx512dq = 1233,                      /* -mavx512dq */
  OPT_mavx512er = 1234,                      /* -mavx512er */
  OPT_mavx512f = 1235,                       /* -mavx512f */
  OPT_mavx512ifma = 1236,                    /* -mavx512ifma */
  OPT_mavx512pf = 1237,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1238,                    /* -mavx512vbmi */
  OPT_mavx512vl = 1239,                      /* -mavx512vl */
  OPT_mbmi = 1240,                           /* -mbmi */
  OPT_mbmi2 = 1241,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1242,                  /* -mbranch-cost= */
  OPT_mcld = 1243,                           /* -mcld */
  OPT_mclflushopt = 1244,                    /* -mclflushopt */
  OPT_mclwb = 1245,                          /* -mclwb */
  OPT_mcmodel_ = 1246,                       /* -mcmodel= */
  OPT_mconstant_cfstrings = 1247,            /* -mconstant-cfstrings */
  /* OPT_mcpu_ = 1248, */                    /* -mcpu= */
  OPT_mcrc32 = 1249,                         /* -mcrc32 */
  OPT_mcx16 = 1250,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1251,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1252,            /* -mdump-tune-features */
  OPT_mdynamic_no_pic = 1253,                /* -mdynamic-no-pic */
  OPT_mf16c = 1254,                          /* -mf16c */
  OPT_mfancy_math_387 = 1255,                /* -mfancy-math-387 */
  OPT_mfentry = 1256,                        /* -mfentry */
  OPT_mfix_and_continue = 1257,              /* -mfix-and-continue */
  OPT_mfma = 1258,                           /* -mfma */
  OPT_mfma4 = 1259,                          /* -mfma4 */
  OPT_mforce_drap = 1260,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1261,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1262,                       /* -mfpmath= */
  OPT_mfsgsbase = 1263,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1264, */              /* -mfused-madd */
  OPT_mfxsr = 1265,                          /* -mfxsr */
  OPT_mhard_float = 1266,                    /* -mhard-float */
  OPT_mhle = 1267,                           /* -mhle */
  OPT_mieee_fp = 1268,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1269,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1270,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1271,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1272, */            /* -mintel-syntax */
  OPT_mkernel = 1273,                        /* -mkernel */
  OPT_mlarge_data_threshold_ = 1274,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1275,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1276,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1277,                /* -mlong-double-80 */
  OPT_mlwp = 1278,                           /* -mlwp */
  OPT_mlzcnt = 1279,                         /* -mlzcnt */
  OPT_mmacosx_version_min_ = 1280,           /* -mmacosx-version-min= */
  OPT_mmemcpy_strategy_ = 1281,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1282,              /* -mmemset-strategy= */
  OPT_mmmx = 1283,                           /* -mmmx */
  OPT_mmovbe = 1284,                         /* -mmovbe */
  OPT_mmpx = 1285,                           /* -mmpx */
  OPT_mms_bitfields = 1286,                  /* -mms-bitfields */
  OPT_mmwaitx = 1287,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1288,            /* -mno-align-stringops */
  OPT_mno_default = 1289,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1290,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1291,                  /* -mno-push-args */
  OPT_mno_red_zone = 1292,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1293,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1294,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1295,       /* -momit-leaf-frame-pointer */
  OPT_mone_byte_bool = 1296,                 /* -mone-byte-bool */
  OPT_mpc32 = 1297,                          /* -mpc32 */
  OPT_mpc64 = 1298,                          /* -mpc64 */
  OPT_mpc80 = 1299,                          /* -mpc80 */
  OPT_mpclmul = 1300,                        /* -mpclmul */
  OPT_mpcommit = 1301,                       /* -mpcommit */
  OPT_mpopcnt = 1302,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1303,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1304,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1305,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1306,                        /* -mprfchw */
  OPT_mpush_args = 1307,                     /* -mpush-args */
  OPT_mrdrnd = 1308,                         /* -mrdrnd */
  OPT_mrdseed = 1309,                        /* -mrdseed */
  OPT_mrecip = 1310,                         /* -mrecip */
  OPT_mrecip_ = 1311,                        /* -mrecip= */
  OPT_mrecord_mcount = 1312,                 /* -mrecord-mcount */
  OPT_mred_zone = 1313,                      /* -mred-zone */
  OPT_mregparm_ = 1314,                      /* -mregparm= */
  OPT_mrtd = 1315,                           /* -mrtd */
  OPT_mrtm = 1316,                           /* -mrtm */
  OPT_msahf = 1317,                          /* -msahf */
  OPT_msha = 1318,                           /* -msha */
  OPT_mskip_rax_setup = 1319,                /* -mskip-rax-setup */
  OPT_msoft_float = 1320,                    /* -msoft-float */
  OPT_msse = 1321,                           /* -msse */
  OPT_msse2 = 1322,                          /* -msse2 */
  OPT_msse2avx = 1323,                       /* -msse2avx */
  OPT_msse3 = 1324,                          /* -msse3 */
  OPT_msse4 = 1325,                          /* -msse4 */
  OPT_msse4_1 = 1326,                        /* -msse4.1 */
  OPT_msse4_2 = 1327,                        /* -msse4.2 */
  OPT_msse4a = 1328,                         /* -msse4a */
  /* OPT_msse5 = 1329, */                    /* -msse5 */
  OPT_msseregparm = 1330,                    /* -msseregparm */
  OPT_mssse3 = 1331,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1332,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1333,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1334,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1335,            /* -mstringop-strategy= */
  OPT_mtbm = 1336,                           /* -mtbm */
  OPT_mtls_dialect_ = 1337,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1338,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1339,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1340,                         /* -mtune= */
  /* OPT_multi_module = 1341, */             /* -multi_module */
  /* OPT_multiply_defined = 1342, */         /* -multiply_defined */
  /* OPT_multiply_defined_unused = 1343, */  /* -multiply_defined_unused */
  OPT_mveclibabi_ = 1344,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1345,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1346,                    /* -mvzeroupper */
  OPT_mx32 = 1347,                           /* -mx32 */
  OPT_mxop = 1348,                           /* -mxop */
  OPT_mxsave = 1349,                         /* -mxsave */
  OPT_mxsavec = 1350,                        /* -mxsavec */
  OPT_mxsaveopt = 1351,                      /* -mxsaveopt */
  OPT_mxsaves = 1352,                        /* -mxsaves */
  OPT_n = 1353,                              /* -n */
  OPT_no_canonical_prefixes = 1354,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1355,              /* -no-integrated-cpp */
  /* OPT_no_dead_strip_inits_and_terms = 1356, *//* -no_dead_strip_inits_and_terms */
  OPT_nocpp = 1357,                          /* -nocpp */
  OPT_nodefaultlibs = 1358,                  /* -nodefaultlibs */
  OPT_nofixprebinding = 1359,                /* -nofixprebinding */
  OPT_nomultidefs = 1360,                    /* -nomultidefs */
  OPT_noprebind = 1361,                      /* -noprebind */
  OPT_noseglinkedit = 1362,                  /* -noseglinkedit */
  OPT_nostartfiles = 1363,                   /* -nostartfiles */
  OPT_nostdinc = 1364,                       /* -nostdinc */
  OPT_nostdinc__ = 1365,                     /* -nostdinc++ */
  OPT_nostdlib = 1366,                       /* -nostdlib */
  OPT_o = 1367,                              /* -o */
  OPT_object = 1368,                         /* -object */
  OPT_p = 1369,                              /* -p */
  OPT_pagezero_size = 1370,                  /* -pagezero_size */
  OPT_pass_exit_codes = 1371,                /* -pass-exit-codes */
  /* OPT_pedantic = 1372, */                 /* -pedantic */
  OPT_pedantic_errors = 1373,                /* -pedantic-errors */
  OPT_pg = 1374,                             /* -pg */
  OPT_pie = 1375,                            /* -pie */
  OPT_pipe = 1376,                           /* -pipe */
  OPT_prebind = 1377,                        /* -prebind */
  OPT_prebind_all_twolevel_modules = 1378,   /* -prebind_all_twolevel_modules */
  OPT_preload = 1379,                        /* -preload */
  OPT_print_file_name_ = 1380,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1381,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1382,          /* -print-multi-directory */
  OPT_print_multi_lib = 1383,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1384,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1385,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1386,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1387,               /* -print-prog-name= */
  OPT_print_search_dirs = 1388,              /* -print-search-dirs */
  OPT_print_sysroot = 1389,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1390,   /* -print-sysroot-headers-suffix */
  OPT_private_bundle = 1391,                 /* -private_bundle */
  OPT_pthread = 1392,                        /* -pthread */
  OPT_quiet = 1393,                          /* -quiet */
  OPT_r = 1394,                              /* -r */
  OPT_read_only_relocs = 1395,               /* -read_only_relocs */
  OPT_remap = 1396,                          /* -remap */
  OPT_s = 1397,                              /* -s */
  OPT_s_bc_abi = 1398,                       /* -s-bc-abi */
  OPT_save_temps = 1399,                     /* -save-temps */
  OPT_save_temps_ = 1400,                    /* -save-temps= */
  OPT_sectalign = 1401,                      /* -sectalign */
  OPT_sectcreate = 1402,                     /* -sectcreate */
  OPT_sectobjectsymbols = 1403,              /* -sectobjectsymbols */
  OPT_sectorder = 1404,                      /* -sectorder */
  OPT_seg1addr = 1405,                       /* -seg1addr */
  /* OPT_seg_addr_table = 1406, */           /* -seg_addr_table */
  /* OPT_seg_addr_table_filename = 1407, */  /* -seg_addr_table_filename */
  /* OPT_segaddr = 1408, */                  /* -segaddr */
  OPT_segcreate = 1409,                      /* -segcreate */
  OPT_seglinkedit = 1410,                    /* -seglinkedit */
  OPT_segprot = 1411,                        /* -segprot */
  /* OPT_segs_read_only_addr = 1412, */      /* -segs_read_only_addr */
  /* OPT_segs_read_write_addr = 1413, */     /* -segs_read_write_addr */
  OPT_shared = 1414,                         /* -shared */
  OPT_shared_libgcc = 1415,                  /* -shared-libgcc */
  /* OPT_single_module = 1416, */            /* -single_module */
  /* OPT_specs = 1417, */                    /* -specs */
  OPT_specs_ = 1418,                         /* -specs= */
  OPT_static = 1419,                         /* -static */
  OPT_static_libasan = 1420,                 /* -static-libasan */
  OPT_static_libgcc = 1421,                  /* -static-libgcc */
  OPT_static_libgcj = 1422,                  /* -static-libgcj */
  OPT_static_libgfortran = 1423,             /* -static-libgfortran */
  OPT_static_libgo = 1424,                   /* -static-libgo */
  OPT_static_liblsan = 1425,                 /* -static-liblsan */
  OPT_static_libmpx = 1426,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1427,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1428,               /* -static-libstdc++ */
  OPT_static_libtsan = 1429,                 /* -static-libtsan */
  OPT_static_libubsan = 1430,                /* -static-libubsan */
  /* OPT_std_c__03 = 1431, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1432, */                /* -std=c++0x */
  OPT_std_c__11 = 1433,                      /* -std=c++11 */
  OPT_std_c__14 = 1434,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1435, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1436, */                /* -std=c++1y */
  OPT_std_c__1z = 1437,                      /* -std=c++1z */
  OPT_std_c__98 = 1438,                      /* -std=c++98 */
  OPT_std_c11 = 1439,                        /* -std=c11 */
  /* OPT_std_c1x = 1440, */                  /* -std=c1x */
  /* OPT_std_c89 = 1441, */                  /* -std=c89 */
  OPT_std_c90 = 1442,                        /* -std=c90 */
  OPT_std_c99 = 1443,                        /* -std=c99 */
  /* OPT_std_c9x = 1444, */                  /* -std=c9x */
  OPT_std_f2003 = 1445,                      /* -std=f2003 */
  OPT_std_f2008 = 1446,                      /* -std=f2008 */
  OPT_std_f2008ts = 1447,                    /* -std=f2008ts */
  OPT_std_f95 = 1448,                        /* -std=f95 */
  OPT_std_gnu = 1449,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1450, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1451, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1452,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1453,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1454, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1455, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1456,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1457,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1458,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1459, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1460, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1461,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1462,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1463, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1464, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1465,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1466, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1467, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1468, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1469,                     /* -std=legacy */
  OPT_sub_library = 1470,                    /* -sub_library */
  OPT_sub_umbrella = 1471,                   /* -sub_umbrella */
  OPT_symbolic = 1472,                       /* -symbolic */
  OPT_t = 1473,                              /* -t */
  OPT_time = 1474,                           /* -time */
  OPT_time_ = 1475,                          /* -time= */
  OPT_traditional = 1476,                    /* -traditional */
  OPT_traditional_cpp = 1477,                /* -traditional-cpp */
  OPT_trigraphs = 1478,                      /* -trigraphs */
  OPT_twolevel_namespace = 1479,             /* -twolevel_namespace */
  OPT_twolevel_namespace_hints = 1480,       /* -twolevel_namespace_hints */
  OPT_u = 1481,                              /* -u */
  /* OPT_umbrella = 1482, */                 /* -umbrella */
  OPT_undef = 1483,                          /* -undef */
  OPT_undefined = 1484,                      /* -undefined */
  /* OPT_unexported_symbols_list = 1485, */  /* -unexported_symbols_list */
  OPT_v = 1486,                              /* -v */
  OPT_version = 1487,                        /* -version */
  OPT_w = 1488,                              /* -w */
  /* OPT_weak_reference_mismatches = 1489, *//* -weak_reference_mismatches */
  OPT_whatsloaded = 1490,                    /* -whatsloaded */
  OPT_whyload = 1491,                        /* -whyload */
  OPT_wrapper = 1492,                        /* -wrapper */
  OPT_x = 1493,                              /* -x */
  OPT_y = 1494,                              /* -y */
  OPT_z = 1495,                              /* -z */
  N_OPTS,
