...
#define gt_ggc_m_27hash_table_cfstring_hasher_(X) do { \
  if (X != NULL) gt_ggc_mx_hash_table_cfstring_hasher_ (X);\
  } while (0)
extern void gt_ggc_mx_hash_table_cfstring_hasher_ (void *);
...
#define gt_ggc_m_30hash_table_indirection_hasher_(X) do { \
  if (X != NULL) gt_ggc_mx_hash_table_indirection_hasher_ (X);\
  } while (0)
extern void gt_ggc_mx_hash_table_indirection_hasher_ (void *);
...
#define gt_ggc_m_20hash_map_gimple_int_(X) do { \
  if (X != NULL) gt_ggc_mx_hash_map_gimple_int_ (X);\
  } while (0)
...
#define gt_ggc_m_20section_hash_entry_d(X) do { \
  if (X != NULL) gt_ggc_mx_section_hash_entry_d (X);\
  } while (0)
...
#define gt_pch_n_30hash_table_named_label_hasher_(X) do { \
  if (X != NULL) gt_pch_nx_hash_table_named_label_hasher_ (X);\
  } while (0)
...
#define gt_pch_n_25hash_table_c_type_hasher_(X) do { \
  if (X != NULL) gt_pch_nx_hash_table_c_type_hasher_ (X);\
  } while (0)
...
#define gt_pch_n_27hash_table_cfstring_hasher_(X) do { \
  if (X != NULL) gt_pch_nx_hash_table_cfstring_hasher_ (X);\
  } while (0)
extern void gt_pch_nx_hash_table_cfstring_hasher_ (void *);
...
#define gt_pch_n_30hash_table_indirection_hasher_(X) do { \
  if (X != NULL) gt_pch_nx_hash_table_indirection_hasher_ (X);\
  } while (0)
extern void gt_pch_nx_hash_table_indirection_hasher_ (void *);
...
#define gt_pch_n_33function_summary_inline_summary__(X) do { \
  if (X != NULL) gt_pch_nx_function_summary_inline_summary__ (X);\
  } while (0)
...
#define gt_pch_n_24vec_ipa_alignment_va_gc_(X) do { \
  if (X != NULL) gt_pch_nx_vec_ipa_alignment_va_gc_ (X);\
  } while (0)
...
#define gt_pch_n_28hash_table_dllimport_hasher_(X) do { \
...
#define gt_pch_n_20hash_map_gimple_int_(X) do { \
  if (X != NULL) gt_pch_nx_hash_map_gimple_int_ (X);\
  } while (0)
...
#define gt_pch_n_14inline_summary(X) do { \
  if (X != NULL) gt_pch_nx_inline_summary (X);\
  } while (0)
...
#define gt_pch_n_20section_hash_entry_d(X) do { \
  if (X != NULL) gt_pch_nx_section_hash_entry_d (X);\
  } while (0)
...
extern void gt_pch_p_35hash_table_value_annotation_hasher_
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_27hash_table_cfstring_hasher_
    (void *, void *, gt_pointer_operator, void *);
...
extern void gt_pch_p_31vec_darwin_lto_section_e_va_gc_
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_30hash_table_indirection_hasher_
    (void *, void *, gt_pointer_operator, void *);
